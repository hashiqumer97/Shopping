    ...
    public partial class initialmigration3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Address", "ContactNumber", "CustomerName" },
                values: new object[,]
                {
                    { 1, "256, Galle Road, Colombo 06", "0765763465", "John Silva" },
                    { 2, "256, Kandy Road, Kandy", "0774653354", "Peter Parker" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "ProductDescription", "ProductName", "Quantity", "UnitPrice" },
                values: new object[,]
                {
                    { 1, "Put it on your head and rub it!", "Shampoo", 150, 100 },
                    { 2, "Used to make tea and coffee.", "Milk Powder", 100, 200 }
                });
